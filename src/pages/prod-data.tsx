...
const COLUMNS: { key: keyof ProdOrderComponent; label: string }[] = [
  { key: "dyn365bc_prodorderno", label: "Prod. Order No." },
  { key: "dyn365bc_prodorderlineno", label: "Line" },
  { key: "dyn365bc_lineno", label: "Comp. Line" },
  ...
  { key: "dyn365bc_quantityper", label: "Qty per" },
  { key: "dyn365bc_remainingquantity", label: "Remaining" },
  { key: "dyn365bc_expectedquantity", label: "Expected" },
  { key: "dyn365bc_unitofmeasurecode", label: "UoM" },
  { key: "dyn365bc_locationcode", label: "Location" },
  { key: "dyn365bc_bincode", label: "Bin" },
  { key: "dyn365bc_variantcode", label: "Variant" },
  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold">Production data</h1>
